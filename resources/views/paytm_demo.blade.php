...
<body>
    ...
    <form action="{{ url('/paytm/sandbox/create') }}" method="post">
        <input type="text" name="refresh_token" value="x7zjZ95MRlTMPxGEAeexUlegsWFkmcOSk8VGGe8a36axtmXTevazruVGPzdK0LfHiCRTrbsyYKwM8XPDPlgq82TuTBlY3L8DIliR">
    ...
    <form action="{{ url('/paytm/create') }}" method="post">
